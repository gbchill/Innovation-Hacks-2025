...
function WelcomeScreen({ onGetStarted }: WelcomeScreenProps) {
  return (
    <div className="relative h-screen flex flex-col items-center justify-center bg-[#181414] px-6 overflow-hidden">
      {/* Gradient Overlay */}
      ...
      <div className="z-10 max-w-xl text-center">
        <h1 className="text-5xl font-bold text-[#ffffff] mb-6 leading-tight">
          Welcome to WorkNest
        </h1>
        <p className="text-lg text-[#ffffff] mb-10">
